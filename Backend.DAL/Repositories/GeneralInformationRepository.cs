...
namespace Backend.DAL.Repositories
{
    public class GeneralInformationRepository : GenericRepository<ApplicationContext, GeneralInformation>, IGeneralInformationRepository
    {
        ...
        public List<Fluorography> GetFluorographyById(int id)
        {
            return context.GeneralInformation
                .FirstOrDefault(t => t.Id == id).Fluorographies
                .ToList();
        }

        public List<SurgicalIntervention> GetSurgicalInterventionById(int id)
        {
            return context.GeneralInformation
                .FirstOrDefault(t => t.Id == id).SurgicalIntervention
                .ToList();
        }

        public List<VaccinationStatus> GetVaccinationStatusById(int id)
        {
            return context.GeneralInformation
                .FirstOrDefault(t => t.Id == id).VaccinationStatuses
                .ToList();
        }
